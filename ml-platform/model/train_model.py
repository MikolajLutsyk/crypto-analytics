...
def load_feature_data():
    ...
    try:
        ...
        print(f"✅ Загружено {len(df)} строк из features.csv")
        return df
    except FileNotFoundError:
        print("❌ Файл features.csv не найден. Сначала запустите feature engineering.")
        return None
...
def train_model(X, y, selected_features):
    ...
    model.fit(
        X_train_balanced, y_train_balanced,  # ← Ключевое изменение!
